...
export const messages = {
  ...
  fa: {
    ...
    hero: { eyebrow: "زندگی کنار آدم‌های خودت بهتر است", title: ["کمتر حساب‌وکتاب.", "بیشتر زندگی."], description: "وقتی با هم زندگی می‌کنید، چیزهای کوچک جمع می‌شوند. هزینه‌ها، نوبت‌ها و برنامه‌ها را یک‌جا و ساده نگه دارید.", primary: "دریافت اکیپما", secondary: "همراه جدیدتان را ببینید", note: "برای دوستان ساخته شده؛ مناسب هم‌خانه‌ها و خوابگاهی‌ها.", caption: "همه گروهت، هماهنگ.", stickerTitle: "دوستان خوب. حساب‌های روشن.", stickerCopy: "کمی کمترِ «کی به کی بدهکار است؟»" },
    ...
    plans: [
      { name: "رایگان", caption: "برای تو و آدم‌های موردعلاقه‌ات.", price: "رایگان", period: "یک شروع خوب، همیشه.", features: ["هزینه‌های مشترک و تسویه", "نوبت‌ها و مسئولیت‌های چرخشی", "برنامه با دوستان", "گروه برای زندگی مشترک"], cta: "دریافت اکیپما" },
    ...
    faq: { label: "چند نکته که خوب است بدانید", title: "سؤال‌های خوب.", items: [["اکیپما فقط برای هم‌خانه‌هاست؟", "برای همه کسانی ساخته شده که چیزی را با هم شریک‌اند. هم‌خانه‌ها و دوستان خوابگاهی عالی‌اند، اما برای جمع شام، دوستان سفر یا هر گروهی که با هم برنامه می‌چیند هم کاربرد دارد."], ["هزینه‌های مشترک چطور کار می‌کنند؟", "مبلغی را که پرداخت کرده‌اید ثبت کنید، افراد شریک را انتخاب کنید تا اکیپما سهم هر نفر را محاسبه کند. بدهی‌ها، تسویه‌ها و تأیید پرداخت‌ها را دنبال کنید."], ["چه کارهایی را می‌توانیم نوبتی انجام دهیم؟", "هر کاری که در گروه می‌چرخد: ظرف شستن، تمیز کردن آشپزخانه یا خرید بعدی. ترتیب و بازه را مشخص کنید و با انجام هر نوبت به نفر بعدی بروید."], ["چه چیزی در یک برنامه قرار می‌گیرد؟", "نام، آدم‌ها، زمان و مکان را کنار هم بگذارید. از جلسه درس تا دورهمی آخر هفته، همه جزئیات کنار هم می‌مانند."]] },
    ...
    contact: { title: "دنبال چیزی بزرگ‌تر هستید؟", copy: "ببینیم اکیپما چطور می‌تواند برای شرکت یا جامعه شما مناسب باشد.", cta: "تماس با ما", pending: "پاسخ‌گویی به درخواست‌های سازمانی به‌زودی آغاز می‌شود." },
